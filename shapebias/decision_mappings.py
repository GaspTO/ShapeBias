...
from shapebias.helper import human_categories as hc
from shapebias.helper import wordnet_functions as wnf
import pandas as pd
...
class ImageNetProbabilitiesTo1000ClassWNIDsMapping(DecisionMapping):
...
class ImageNetProbabilitiesTo1000ClassNamesMapping(DecisionMapping):
    """Return the Class names sorted by probabilities."""
    def __init__(self):
        self.categories = wnf.get_ilsvrc2012_categories()
...
class ImageNetProbabilitiesTo16ClassNamesMapping(DecisionMapping):
